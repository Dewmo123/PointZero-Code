    ...
    internal class PrepareState : SyncObjectsState
    {
        ...
        private void SetStartPosition()
        {
            ...
            foreach (var item in _room.Sessions.Values)
            {
                ...
                VectorPacket startPos = _room.Attacker == player.team ? attackStartPos[index % 5] : defenseStartPos[index % 5];
                player.SetLocation(startPos.ToVector3(), Quaternion.Identity, Quaternion.Identity, 0, false);
